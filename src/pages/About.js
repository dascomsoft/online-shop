...
import te4  from "../assets/te4.webp";
      ...
      <div className="container">
        <div className='about-showcase'>
          <div className="about-text">
            <h2>ABOUT US</h2>
             <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Perspiciatis, officiis. Fugiat, fugit aperiam suscipit ipsa accusantium eaque minus. Eligendi ullam commodi sit architecto iste. Sit eaque praesentium vitae voluptatibus, repellendus harum ipsam. Nobis placeat, quia nam, reprehenderit laudantium ut fugit perspiciatis soluta eaque quis quidem obcaecati repellat pariatur ipsam incidunt quas odit, recusandae aspernatur saepe possimus. Vero eum commodi sapiente fugit nam eos pariatur, id recusandae cumque? Atque id quo laboriosam at pariatur eius consequuntur fugiat enim! Corporis odit aliquam distinctio harum voluptatum earum accusantium explicabo, tenetur fugiat.</p>
               <br />
              <Link to="/Products" className="join">Visit our products</Link>
          </div>
            <img src={sho6} alt="pico" id="image" />
         </div>
         </div>
         </div>
       ...
       <h2 className="text-center mb-5">Our Team Menbers</h2>

        <div className="container">
         <div className="wrapper-container">
           <div className="article-a">
               <div className="move"><img src={te} alt="" id="test-1" /></div>
                <div className="text">
           ...
           <div className="article-a">
                 <div className="move"><img src={te1} alt="" id="test-1" /></div>
                <div className="text">
                    <h4>Cashier</h4>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam inventore, saepe vero hic sed maxime illo amet nulla molestiae sit modi facere magnam iste fugiat cupiditate placeat eaque nobis facilis?</p>
                  </div>
           ...
           <div className="article-a">
             <div className="move"><img src={te4} alt="" id="test-1" /></div>
                <div className="text">
           ...
           <div className="article-a">
              <div className="move"><img src={t3} alt="" id="test-1" /></div>
                <div className="text">

...
function Contact() {
  ...
  const containerStyle = {
    backgroundImage: `linear-gradient(rgba(20, 21, 51, 0.8), rgba(20, 21, 51, 0.8)),
    url(${sho6.webp})`,
    ...
    <div className="container">
        <div className="section-contact">
            <div className="container">
                <div className="section-contact-content">
                    ...
                    <p className="text-center lead text-warning fw-bold">"Please feel free to contact us for further details and informations. We are at your disposal to assist you"</p>
                </div>
            </div>
          </div>
        <div className="row py-5">
            <div className="col-md-4 text-center circle">
                ...
                <h2>LOCATION</h2>
                <p>Address :99 Belgocity street ,NY-USA</p>
            </div>

            <div className="col-md-4 text-center">
               
            <p>
                  <svg fill="orange" width="50px" height="50px" viewBox="0 0 24 24" id="phone" data-name="Flat Color" xmlns="http://www.w3.org/2000/svg" className="icon flat-color"><path id="primary" d="M20.19,13a10,10,0,0,1-3.43-.91,2,2,0,0,0-2.56.83l-.51.85a12.69,12.69,0,0,1-3.44-3.45l.86-.49a2,2,0,0,0,.83-2.56A10,10,0,0,1,11,3.81,2,2,0,0,0,9,2H5.13A3,3,0,0,0,2.86,3a3.13,3.13,0,0,0-.71,2.43A19,19,0,0,0,18.58,21.85a3,3,0,0,0,.42,0,3,3,0,0,0,2-.73,3,3,0,0,0,1-2.26V15A2,2,0,0,0,20.19,13Z" fill="orange"></path></svg>
                
                </p>
                <h2>PHONE</h2>
                <p>Tel : +1(65)-569-47-67</p>
            </div>

            <div className="col-md-4 text-center">
                <p>
                  <svg width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6zm3.519 0L12 11.671 18.481 6H5.52zM20 7.329l-7.341 6.424a1 1 0 0 1-1.318 0L4 7.329V18h16V7.329z" fill="orange"/></svg>
                
                </p>
                <h2>EMAIL</h2>
                <p>Email: kikstore@store.com</p>
            </div>
        </div> 
       </div>
